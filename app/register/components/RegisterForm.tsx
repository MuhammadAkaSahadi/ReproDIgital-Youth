...
export function RegisterForm() {
  ...
  const { register, handleSubmit, formState: { errors }, watch, setValue, trigger } = useForm<RegisterSchema>({
  ...
  return (
    <div className="w-full max-w-[480px] mx-auto">
      ...
      <div className="mb-10 text-center lg:text-left">
        <h1 className="text-[28px] md:text-[32px] font-heading font-bold text-gray-900 leading-tight">
          Daftar Akun Baru
        </h1>
        <p className="text-[15px] md:text-[16px] text-gray-600 mt-2">
          Bergabung dengan ribuan remaja lainnya.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="space-y-2">
            <Label className="text-[14px] text-gray-700 font-semibold">
            ...
            >
              <SelectTrigger
                className={`h-12 px-4 border focus:ring-1 focus:ring-teal-500 focus:border-teal-500 rounded-lg text-[15px] ${errors.grade ? "border-red-500 bg-red-50/50" : "border-gray-200"}`}
              >
        ...
        <div className="space-y-2">
          ...
          {passwordValue.length > 0 && (
            <div className="mt-2 space-y-1">
              ...
              <p className="text-[12px] text-gray-500 font-medium text-right capitalize">
                {getStrengthText()}
              </p>
            </div>
          )}
        ...
        <div className="pt-2 pb-2">
          <div className="flex items-start gap-3">
            ...
            <div className="grid leading-tight">
              <label
                htmlFor="terms"
                className="text-[13.5px] font-medium text-gray-600 cursor-pointer select-none"
              >
                Saya setuju dengan{" "}
        ...
        <div className="relative py-4 flex items-center">
          ...
          <span className="bg-white px-4 text-[13px] text-gray-400 font-medium tracking-wide">
            ATAU
          </span>
          <div className="flex-1 border-t border-gray-200"></div>
        </div>
        ...
        <p className="text-center text-[14px] text-gray-600 mt-6 pb-6">
          ...
          <Link
            href="/login"
            className="text-teal-600 font-bold hover:text-coral-500 hover:underline transition-colors"
          >
            Masuk di sini
          </Link>
        </p>
